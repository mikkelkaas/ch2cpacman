        ...
        <table className="w-full text-sm">
          <thead className="text-left text-xs text-gray-500 uppercase">
            <tr>
              ...
              <th className="py-1 text-right">{da.eaten}</th>
            </tr>
          </thead>
  ...
  return (
    <>
      <tr onClick={onToggle} className="cursor-pointer hover:bg-gray-50">
        ...
        <td className="py-2 text-right text-gray-700 tabular-nums">{score.pellets.length}</td>
      </tr>
      {open && (
        <tr>
          <td colSpan={4} className="pb-3 pl-10 text-xs text-gray-500">
