...
export const sound = {
  ...
  /** Two alternating tones, the arcade ghost siren; one bar, callers repeat. */
  siren: () => play([[440, 0, 0.18], [523, 0.2, 0.18]], 'sawtooth'),
  power: () => play([[262, 0, 0.08], [330, 0.09, 0.08], [392, 0.18, 0.08], [523, 0.27, 0.08], [659, 0.36, 0.2]]),
  ghostEaten: () => play([[880, 0, 0.05], [1175, 0.06, 0.05], [1568, 0.12, 0.12]]),
  hurt: () => play([[330, 0, 0.12], [247, 0.13, 0.12], [165, 0.26, 0.3]], 'sawtooth'),
};
